...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'XYH', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个无趣的程序员', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://xyh.wiki', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '技术, 博客, 大数据, 分享', // 网站关键词 英文逗号隔开
